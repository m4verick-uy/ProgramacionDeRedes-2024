...
- **ParameterizedThreadStart** es un delegado que permite ejecutar un método en un hilo con un parámetro de tipo `object`, proporcionando flexibilidad en el manejo de datos dentro del hilo.
